...
# The central-db image to use (default: "registry.redhat.io/advanced-cluster-security/rhacs-central-db:3.68.x-30-g516b4e7a6c-dirty"):
expect {
  default {
  ...
  "The central-db * (default: \"$registry/rhacs-central-db:*\"):" {
    send_user "roxctl suggests correct registry for central-db"
    send "\n"
  }
}
...
# The main image to use (default: "registry.redhat.io/advanced-cluster-security/rhacs-main:3.68.x-30-g516b4e7a6c-dirty"):
expect {
  default {
  ...
  # Special case for RHACS to avoid writing a regexp in TCL
  "The main * (default: \"$registry/rhacs-main:*\"):" {
    send_user "roxctl suggests correct registry for main"
    send "\n"
  }
}
...
# The scanner-db image to use (default: "registry.redhat.io/advanced-cluster-security/rhacs-scanner-db:3.68.x-30-g516b4e7a6c-dirty"):
expect {
  default {
  ...
  # Special case for RHACS to avoid writing a regexp in TCL
  "The scanner-db * (default: \"$registry/rhacs-scanner-db:*\"):" {
    send_user "roxctl suggests correct registry for scanner-db"
    send "\n"
  }
}
...
expect {
  ...
  # Special case for RHACS to avoid writing a regexp in TCL
  "The scanner * (default: \"$registry/rhacs-scanner:*\"):" {
    send_user "roxctl suggests correct registry for scanner"
    send "\n"
  }
}
...
expect {
  ...
  # Special case for RHACS to avoid writing a regexp in TCL
  "The scanner-v4-db * (default: \"$registry/rhacs-scanner-v4-db:*\"):" {
    send_user "roxctl suggests correct registry for scanner-v4-db"
    send "\n"
  }
}
...
expect {
  ...
  # Special case for RHACS to avoid writing a regexp in TCL
  "The scanner-v4 * (default: \"$registry/rhacs-scanner-v4:*\"):" {
    send_user "roxctl suggests correct registry for scanner-v4"
    send "\n"
  }
}
