...
assert_prompts_rhacs() {
  assert_line --regexp '^The main .* "registry.redhat.io/advanced-cluster-security/rhacs-main:'
  assert_line --regexp '^The scanner-db .* "registry.redhat.io/advanced-cluster-security/rhacs-scanner-db:'
  assert_line --regexp '^The scanner .* "registry.redhat.io/advanced-cluster-security/rhacs-scanner:'
}
